            ...
            <div className="bg-white border border-[#403c21]/20 rounded-3xl p-5 sm:p-6 shadow-xs mb-6 text-[#403c21]">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="flex justify-end space-x-3 pt-2">
                  ...
                  <button
                    type="submit"
                    className="px-6 py-2.5 bg-[#403c21] hover:bg-[#33301a] text-white font-black text-xs rounded-full shadow-md transition cursor-pointer active:scale-95"
                  >
      ...
      <div className="bg-white rounded-3xl p-4 border border-[#403c21]/20 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-4 text-[#403c21]">
        ...
        <div className="flex bg-[#f7f5f0] p-1 rounded-full border border-[#403c21]/20 text-xs font-medium w-full sm:w-auto">
          <button
            ...
            className={`px-4 py-1.5 rounded-full transition cursor-pointer flex-1 sm:flex-none font-extrabold ${filterStatus === 'unsettled' ? 'bg-[#403c21] text-white font-bold shadow-xs' : 'text-neutral-600 hover:text-[#403c21]'}`}
          >
            Weekly Unsettled
          </button>
          <button
            onClick={() => setFilterStatus('settled')}
            className={`px-4 py-1.5 rounded-full transition cursor-pointer flex-1 sm:flex-none font-extrabold ${filterStatus === 'settled' ? 'bg-[#403c21] text-white font-bold shadow-xs' : 'text-neutral-600 hover:text-[#403c21]'}`}
          >
            Settled Paid
          </button>
          <button
            onClick={() => setFilterStatus('all')}
            className={`px-4 py-1.5 rounded-full transition cursor-pointer flex-1 sm:flex-none font-extrabold ${filterStatus === 'all' ? 'bg-[#403c21] text-white font-bold shadow-xs' : 'text-neutral-600 hover:text-[#403c21]'}`}
          >
            All Logs
          </button>
        </div>
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center flex-wrap gap-2">
                      ...
                      {item.isSettledWeekly ? (
                        ...
                        <span className="bg-[#403c21] text-white font-bold text-[10px] font-extrabold px-3 py-0.5 rounded-full uppercase">
                          UNSETTLED
                        </span>
                      )}
                    </div>
                  ...
                  <div className="flex items-center space-x-2">
                    {!item.isSettledWeekly ? (
                      <button
                        ...
                        className="px-4 py-2 bg-[#403c21] hover:bg-[#33301a] text-white font-black text-xs rounded-full shadow-md flex items-center space-x-1.5 cursor-pointer active:scale-95 transition"
                      >
