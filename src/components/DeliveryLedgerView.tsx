        ...
        {editingRecord && (
          ...
          >
            <motion.div 
              ...
              className="bg-[#0B1D2C] rounded-3xl shadow-2xl max-w-lg w-full p-6 border border-[#0B1D2C]/50 space-y-4 text-white"
            >
              <div className="flex items-center justify-between border-b border-[#0B1D2C]/30 pb-4">
                ...
                <button
                  ...
                  className="p-2 text-[#0B1D2C]/70 hover:text-white hover:bg-[#0B1D2C]/30 rounded-full transition cursor-pointer"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              >
                ...
                <div className="pt-4 flex items-center justify-end space-x-3 border-t border-[#0B1D2C]/30">
                  <button
                    type="button"
                    onClick={() => setEditingRecord(null)}
                    className="px-5 py-2.5 bg-[#0B1D2C] border border-[#0B1D2C] text-white hover:bg-[#0B1D2C]/30 font-bold text-xs rounded-full cursor-pointer transition"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="px-6 py-2.5 bg-[#0B1D2C] hover:bg-[#0B1D2C]/90 text-[#0B1D2C] font-bold text-xs rounded-full shadow-md cursor-pointer flex items-center space-x-1.5 transition"
                  >
                    <Save className="w-4 h-4 text-[#0B1D2C]" />
