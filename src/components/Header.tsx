        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1 bg-[#f7f5f0] p-1 rounded-full border border-[#403c21]/20">
              ...
              >
                <Sun className={`w-3.5 h-3.5 ${activeShift === 'day' ? 'text-[#f7f5f0]' : 'text-[#403c21]'}`} />
                <span>Day</span>
              </button>
              ...
              >
                <Moon className={`w-3.5 h-3.5 ${activeShift === 'night' ? 'text-[#f7f5f0]' : 'text-[#403c21]'}`} />
                <span>Night</span>
              </button>
            </div>
            ...
            <div className="relative" ref={menuRef}>
              ...
              >
                <div className="w-7 h-7 rounded-full bg-[#403c21] text-[#f7f5f0] flex items-center justify-center font-extrabold text-xs shadow-xs">
                  <User className="w-4 h-4 text-[#f7f5f0]" />
                </div>
              ...
              <AnimatePresence>
                {isProfileMenuOpen && (
                  <motion.div
                    ...
                    className="absolute right-0 mt-2 w-72 bg-[#403c21] rounded-3xl shadow-2xl border border-[#403c21]/40 p-4 z-50 text-[#f7f5f0] space-y-4"
                  >
                    {/* User Info Header */}
                    <div className="flex items-center gap-3 p-3 bg-[#33301a] rounded-2xl border border-[#403c21]/30">
                      <div className="w-10 h-10 rounded-full bg-[#403c21] text-[#f7f5f0] flex items-center justify-center font-extrabold shadow-xs">
                        <User className="w-5 h-5 text-[#f7f5f0]" />
                      </div>
                      <div>
                        <h4 className="font-extrabold text-sm text-[#f7f5f0]">{currentWorker}</h4>
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[11px] font-extrabold uppercase tracking-wider text-[#f7f5f0]/80 px-1">
                        Switch Duty Shift
                      </label>
                      <div className="grid grid-cols-2 gap-2 bg-[#33301a] p-1.5 rounded-2xl border border-[#403c21]/30">
                        <button
                          ...
                          className={`flex items-center justify-center gap-2 py-2 rounded-xl text-xs font-extrabold transition-all cursor-pointer ${
                            activeShift === 'day'
                              ...
                              : 'text-[#f7f5f0]/80 hover:text-[#f7f5f0] hover:bg-[#403c21]'
                          }`}
                        >
                          <Sun className={`w-4 h-4 ${activeShift === 'day' ? 'text-[#403c21]' : 'text-[#f7f5f0]'}`} />
                          <span>Day Shift</span>
                        </button>
                        ...
                        >
                          <Moon className={`w-4 h-4 ${activeShift === 'night' ? 'text-[#403c21]' : 'text-[#f7f5f0]'}`} />
                    ...
                    <div className="space-y-1 border-t border-[#f7f5f0]/20 pt-3">
                      <a
                        ...
                        className="flex items-center justify-between px-3 py-2.5 rounded-xl hover:bg-[#33301a] text-xs font-bold text-[#f7f5f0] transition-colors"
                      >
                        <div className="flex items-center gap-2">
                          <Smartphone className="w-4 h-4 text-[#f7f5f0]" />
                      ...
                      <button
                        ...
                        className="w-full flex items-center justify-between px-3 py-2.5 rounded-xl hover:bg-[#33301a] text-xs font-bold text-[#f7f5f0] transition-colors cursor-pointer"
                      >
                        <div className="flex items-center gap-2">
                          <Settings className="w-4 h-4 text-[#f7f5f0]" />
                          <span>System Settings</span>
                        </div>
                        <ChevronRight className="w-4 h-4 text-[#f7f5f0]/80" />
                      </button>
                    </div>
                    ...
                    <div className="border-t border-[#f7f5f0]/20 pt-3">
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-2 py-2.5 rounded-2xl text-xs font-extrabold text-[#f7f5f0] bg-[#000000]/60 hover:bg-[#000000] border border-[#f7f5f0]/30 transition-all cursor-pointer active:scale-95"
                      >
                        <LogOut className="w-4 h-4 text-[#f7f5f0]" />
                        <span>Log Out</span>
                      </button>
                    </div>
                  </motion.div>
        ...
        <div className="mt-3 flex gap-1.5 overflow-x-auto no-scrollbar pb-1">
          {tabs.map((tab) => {
            ...
            const activeClasses = isActive 
              ? 'bg-[#403c21] text-[#f7f5f0] font-extrabold shadow-xs' 
            ...
            return (
              ...
              >
                <Icon className={`w-4 h-4 ${isActive ? 'text-[#f7f5f0]' : 'text-[#403c21]'}`} />
                <span>{tab.label}</span>
                ...
                {tab.count !== undefined && tab.count > 0 && (
                  <span className={`flex items-center justify-center min-w-[20px] h-[20px] px-1.5 rounded-full text-[10px] font-extrabold ml-1 ${
                    isActive ? 'bg-[#f7f5f0] text-[#403c21]' : 'bg-[#403c21] text-[#f7f5f0]'
                  }`}>
                    {tab.count}
                  </span>
                )}
