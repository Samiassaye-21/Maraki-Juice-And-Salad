...
export const BudgetSettings: React.FC<BudgetSettingsProps> = ({
  ...
  const getCategoryBadge = (category?: string) => {
    switch (category) {
      case 'traditional':
        return <span className="bg-[#403c21] text-white font-bold text-[10px] font-bold px-2.5 py-0.5 rounded-full uppercase">Traditional</span>;
      case 'fast_food':
        return <span className="bg-[#403c21] text-white font-bold text-[10px] font-bold px-2.5 py-0.5 rounded-full uppercase">Fast Food</span>;
      case 'breakfast':
        return <span className="bg-[#403c21] text-white font-bold text-[10px] font-bold px-2.5 py-0.5 rounded-full uppercase">Breakfast</span>;
      case 'special':
        return <span className="bg-[#403c21] text-white font-bold text-[10px] font-bold px-2.5 py-0.5 rounded-full uppercase">Special</span>;
      default:
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="space-y-2 bg-[#f7f5f0] p-4 rounded-3xl border border-[#403c21]/20 text-[#403c21]">
              <label className="text-sm font-extrabold text-[#403c21] flex items-center justify-between">
                ...
                <span className="text-xs text-white font-bold bg-[#403c21] font-extrabold px-3 py-0.5 rounded-full shadow-xs">
                  Editable anytime
                </span>
              </label>
              <input
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-[#403c21] hover:bg-[#33301a] text-white font-black text-xs rounded-full shadow-md transition-colors flex items-center space-x-1.5 cursor-pointer active:scale-95"
              >
                ...
                <div className="bg-[#f7f5f0] border border-[#403c21]/20 rounded-3xl p-4 space-y-3 text-[#403c21]">
                  ...
                  <div className="flex justify-end space-x-2 pt-1">
                    ...
                    <button
                      ...
                      className="px-5 py-2 bg-[#403c21] hover:bg-[#33301a] text-white font-bold text-xs font-extrabold rounded-full shadow-md cursor-pointer active:scale-95"
                    >
                      Save Menu Item
                    </button>
                  </div>
