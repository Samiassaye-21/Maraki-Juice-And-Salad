      ...
      <form onSubmit={handleSubmit} className="bg-[#238868]/20 rounded-3xl border border-[#238868]/40 shadow-sm p-5 sm:p-6 space-y-8">
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-bold text-white flex items-center space-x-2.5">
            <Sparkles className="w-5 h-5 text-[#13EE86]" />
            <span>Juice & Base Unit Pricing</span>
          </h3>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {/* Juice Cup Price */}
            <div className="space-y-2 bg-[#07250D] p-4 rounded-3xl border border-[#238868]/40">
              <label className="text-sm font-bold text-white flex items-center justify-between">
                <span className="flex items-center space-x-2">
                  <CupSoda className="w-5 h-5 text-[#13EE86]" />
                  <span>Juice Cup Unit Price (ETB)</span>
                </span>
                <span className="text-xs text-[#07250D] bg-[#13EE86] font-bold px-3 py-0.5 rounded-full">
                  Editable anytime
                </span>
              </label>
              <input
                ...
                className={`${inputClasses} font-extrabold text-lg text-[#13EE86]`}
              />
              <p className="text-xs text-neutral-300">
                Current rate: <strong className="text-[#13EE86]">{juicePrice} ETB</strong> per cup. Update this anytime as juice costs change to calculate revenues automatically.
              </p>
            </div>
            ...
            <div className="space-y-2 bg-[#07250D] p-4 rounded-3xl border border-[#238868]/40">
              <label className="text-sm font-bold text-white flex items-center space-x-2">
                <UtensilsCrossed className="w-5 h-5 text-[#13EE86]" />
        ...
        <div className="border-t border-[#238868]/30 pt-6 space-y-5">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className="px-4 py-2 bg-[#07250D] border border-[#238868] hover:bg-[#238868]/30 text-white font-bold text-xs rounded-full transition-colors flex items-center space-x-1.5 cursor-pointer"
                title="Reset menu to default Ethiopian dishes"
              >
                <RotateCcw className="w-3.5 h-3.5 text-[#13EE86]" />
              ...
              <button
                ...
                className="px-4 py-2 bg-[#13EE86] hover:bg-[#13EE86]/90 text-[#07250D] font-bold text-xs rounded-full shadow-md transition-colors flex items-center space-x-1.5 cursor-pointer"
              >
          ...
          <AnimatePresence>
            {showAddForm && (
              ...
              >
                <div className="bg-[#07250D] border border-[#238868]/50 rounded-3xl p-4 space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {foodMenu.map((item) => (
              <div 
                key={item.id}
                className="bg-[#07250D] border border-[#238868]/40 rounded-2xl p-3.5 flex items-center justify-between hover:border-[#13EE86]/50 transition-all"
              >
                <div className="space-y-1">
                  ...
                  <div className="text-xs text-[#13EE86] font-extrabold">
                ...
                <div className="flex items-center space-x-1">
                  <button
                    ...
                    title="Edit Item"
                  >
                    <Pencil className="w-3.5 h-3.5 text-[#13EE86]" />
                  </button>
                  <button
                    type="button"
        ...
        <div className="border-t border-[#238868]/30 pt-6 space-y-5">
          <h3 className="text-lg font-bold text-white flex items-center space-x-2.5">
            <User className="w-5 h-5 text-[#13EE86]" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            ...
            <div>
              ...
              <div className="mt-3 bg-[#07250D] border border-[#238868]/40 p-3 rounded-2xl space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-white flex items-center gap-1.5">
                    <PenTool className="w-3.5 h-3.5 text-[#13EE86]" />
                  ...
                  {daySignatureUrl && (
                    <button
                      ...
                      className="text-[10px] text-neutral-300 hover:text-white hover:underline cursor-pointer"
                    >
                      Clear
                    </button>
                  )}
                ...
                {daySignatureUrl ? (
                  <div className="bg-[#07250D] p-2 rounded-xl border border-[#238868]/40 text-center">
                    <img src={daySignatureUrl} alt="Day Worker Master Signature" className="h-14 mx-auto object-contain bg-white rounded-lg p-1" />
                    <p className="text-[10px] text-[#13EE86] font-bold mt-1">✅ Master Signature Saved</p>
                    <button type="button" onClick={() => clearMaster(setDaySignatureUrl)} className="mt-1 text-[10px] text-neutral-300 hover:text-white hover:underline cursor-pointer">Clear & Re-draw</button>
                  </div>
                ) : (
                  <div className="space-y-2">
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 py-3 px-3 bg-[#07250D] hover:bg-[#238868]/30 border-2 border-dashed border-[#238868] rounded-full text-white text-sm font-bold cursor-pointer transition-colors"
                    >
                      <PenTool className="w-4 h-4 text-[#13EE86]" />
                      ✍️ Tap Here to Draw Signature
                    </button>

                    <label className="flex items-center justify-center gap-2 py-2 px-4 bg-[#07250D] hover:bg-[#238868]/30 text-neutral-300 text-xs font-bold rounded-full border border-[#238868] cursor-pointer">
                      <Upload className="w-3.5 h-3.5 text-[#13EE86]" />
              ...
              <div className="mt-3 bg-[#07250D] border border-[#238868]/40 p-3 rounded-2xl space-y-2">
                ...
                {nightSignatureUrl ? (
                  <div className="bg-[#07250D] p-2 rounded-xl border border-[#238868]/40 text-center">
                    ...
                    <p className="text-[10px] text-[#13EE86] font-bold mt-1">✅ Master Signature Saved</p>
                    <button type="button" onClick={() => clearMaster(setNightSignatureUrl)} className="mt-1 text-[10px] text-neutral-300 hover:text-white hover:underline cursor-pointer">Clear & Re-draw</button>
                  </div>
                ) : (
                  <div className="space-y-2">
                    <button
        ...
        {/* SAVE BUTTON */}
        <div className="border-t border-[#238868]/30 pt-6 flex justify-end">
          <motion.button
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            type="submit"
            className="px-8 py-3 rounded-full text-[#07250D] font-bold bg-[#13EE86] hover:bg-[#13EE86]/90 shadow-md transition-all flex items-center justify-center space-x-2 min-w-[170px] cursor-pointer"
          >
