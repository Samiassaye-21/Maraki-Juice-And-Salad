...
export const ShiftEntryView: React.FC<ShiftEntryViewProps> = ({ config }) => {
  ...
  return (
    <div className="min-h-screen bg-[#f7f5f0] text-[#0B1D2C] font-sans pb-12 relative overflow-x-hidden">
      ...
      <AnimatePresence>
        {showSuccess && (
          <motion.div
            ...
            className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#0B1D2C]/95 p-6 backdrop-blur-md text-center"
          >
            <motion.div
              initial={{ scale: 0 }}
      ...
      {/* ─── Top Header Bar ────────────────────────────────────────────────── */}
      <div className="bg-white border-b border-[#0B1D2C]/20 sticky top-0 z-30 backdrop-blur-md px-4 py-3 text-[#0B1D2C]">
        <div className="max-w-md mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="w-10 h-10 rounded-full bg-[#f7f5f0] flex items-center justify-center text-[#0B1D2C] shadow-xs border border-[#0B1D2C]/20">
              <Moon className="w-5 h-5 text-[#0B1D2C]" />
            </div>
            <div>
              <h1 className="font-extrabold text-[#0B1D2C] text-base tracking-tight leading-tight">
                የሸፍት ገቢ መዝገብ
              </h1>
          ...
          <div className="flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-[#f7f5f0] border border-[#0B1D2C]/20 text-[#0B1D2C] text-xs font-extrabold">
            <Clock className="w-3.5 h-3.5 text-[#0B1D2C]" />
      ...
      <div className="max-w-md mx-auto px-4 pt-4 space-y-4">
        ...
        <div className="bg-white text-[#0B1D2C] rounded-3xl p-5 space-y-3 shadow-xs border border-[#0B1D2C]/20">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-full bg-[#f7f5f0] text-[#0B1D2C] flex items-center justify-center border border-[#0B1D2C]/20">
                <AlertCircle className="w-5 h-5" />
              </div>
              <div>
                <h3 className="font-extrabold text-[#0B1D2C] text-sm leading-tight">
                  ያልተከፈለ እዳ ድምር (Total Unpaid Debts)
                </h3>
                <p className="text-[11px] text-neutral-500 font-medium">Unsettled Customer Credit Left</p>
              </div>
            </div>
            <span className="text-xs font-extrabold text-white font-bold bg-[#0B1D2C] px-3.5 py-1 rounded-full shadow-xs">
              {unpaidPendingCount} Debts
            </span>
          </div>

          <div className="flex items-baseline justify-between pt-2 border-t border-[#0B1D2C]/15">
            <div className="text-xs text-neutral-600 font-medium flex items-center gap-2">
              <span className="bg-[#f7f5f0] px-3 py-1 rounded-full border border-[#0B1D2C]/20 text-[#0B1D2C] font-extrabold">
            ...
            <div className="text-2xl font-extrabold text-white font-bold">
        ...
        <div className="bg-white border border-[#0B1D2C]/20 rounded-3xl p-4 space-y-3.5 shadow-md">
          {/* Shift Toggle */}
          <div className="flex items-center gap-2 bg-[#f7f5f0] p-1.5 rounded-full border border-[#0B1D2C]/20">
            <button
              ...
              className={`flex-1 py-2 rounded-full font-bold text-xs flex items-center justify-center gap-2 transition-all cursor-pointer ${
                shiftType === 'night'
                  ...
                  : 'text-neutral-600 hover:text-[#0B1D2C]'
              }`}
            >
              <Moon className={`w-4 h-4 ${shiftType === 'night' ? 'text-[#0B1D2C]' : 'text-neutral-500'}`} />
            ...
            >
              <Sun className={`w-4 h-4 ${shiftType === 'day' ? 'text-[#0B1D2C]' : 'text-neutral-500'}`} />
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-[11px] font-bold text-neutral-600 flex items-center gap-1 mb-1">
                <Calendar className="w-3 h-3 text-[#0B1D2C]" />
              ...
              <input
                ...
                className="w-full bg-white border border-[#0B1D2C]/30 rounded-full px-3.5 py-2 text-xs font-bold text-[#0B1D2C] focus:outline-none focus:border-[#0B1D2C] focus:ring-4 focus:ring-[#0B1D2C]/20 shadow-xs"
              />
            </div>
            <div>
              <label className="text-[11px] font-bold text-neutral-600 flex items-center gap-1 mb-1">
                <User className="w-3 h-3 text-[#0B1D2C]" />
        ...
        <div className="bg-white border border-[#0B1D2C]/20 rounded-3xl p-4 space-y-3 shadow-md">
          <div className="flex items-center justify-between border-b border-[#0B1D2C]/15 pb-2.5">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-[#0B1D2C]/10 text-[#0B1D2C] flex items-center justify-center border border-[#0B1D2C]/30">
                <CupSoda className="w-4 h-4" />
              </div>
              <h2 className="font-extrabold text-[#0B1D2C] text-sm">የጁስ ሂሳብ (Juice Sales)</h2>
            </div>
            <span className="text-xs font-bold text-white font-bold bg-[#0B1D2C] px-3 py-0.5 rounded-full shadow-xs">
          ...
          <div className="grid grid-cols-3 gap-2">
            <div>
              ...
              <input
                ...
                className="w-full bg-white border border-[#0B1D2C]/30 rounded-full px-2.5 py-1.5 text-xs font-bold text-[#0B1D2C] text-center focus:outline-none focus:border-[#0B1D2C]"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-white border-2 border-[#0B1D2C] rounded-full px-2.5 py-1.5 text-xs font-extrabold text-[#0B1D2C] text-center focus:outline-none"
              />
            </div>
          </div>

          <div className="flex items-center justify-between bg-[#f7f5f0] p-2.5 rounded-full border border-[#0B1D2C]/20 text-xs px-4">
            <span className="text-neutral-600 font-medium">Juice Price: {juicePrice} ETB/cup</span>
            <span className="font-extrabold text-[#0B1D2C] text-sm">
        ...
        <div className="bg-white border border-[#0B1D2C]/20 rounded-3xl p-4 space-y-3 shadow-md">
          <div className="flex items-center justify-between border-b border-[#0B1D2C]/15 pb-2.5">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-extrabold text-[#0B1D2C] text-sm">የምግብ ሂሳብ (Food Sales)</h2>
            </div>
            <span className="text-xs font-bold text-white font-bold bg-[#0B1D2C] px-3 py-0.5 rounded-full shadow-xs">
        ...
        <div className="bg-white border border-[#0B1D2C]/20 rounded-3xl p-4 space-y-3.5 shadow-md">
          <h2 className="font-extrabold text-[#0B1D2C] text-sm border-b border-[#0B1D2C]/15 pb-2">
          ...
          <div className="space-y-3">
            ...
            <div>
              <div className="flex justify-between text-xs mb-1">
                <span className="text-[#0B1D2C] font-bold">1. Telebirr / CBE Birr (ለባለቤቱ የተላከ)</span>
              ...
              <input
                ...
                placeholder="0 ETB"
                className="w-full bg-white border border-[#0B1D2C]/30 rounded-full px-3.5 py-2 text-xs font-extrabold text-[#0B1D2C] focus:outline-none focus:border-[#0B1D2C] shadow-xs"
              />
            </div>

            {/* 2. Itemized Daily Expenses with Reasons */}
            <div className="bg-[#f7f5f0] p-3.5 rounded-2xl border border-[#0B1D2C]/20 space-y-2">
              <div className="flex justify-between items-center text-xs">
                <span className="text-[#0B1D2C] font-bold">2. የዕለት ወጪዎች (Itemized Expenses)</span>
                <span className="text-[#0B1D2C] font-extrabold text-xs">
              ...
              {expenseList.length > 0 && (
                <div className="divide-y divide-[#0B1D2C]/15 border-y border-[#0B1D2C]/15 my-1 py-1">
                  {expenseList.map((item) => (
                    <div key={item.id} className="flex items-center justify-between text-xs py-1">
                      <span className="text-[#0B1D2C] font-medium">{item.title}</span>
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-[#0B1D2C]">{item.amount} ETB</span>
                        <button
                          onClick={() => handleRemoveExpenseItem(item.id)}
                          className="text-[#0B1D2C]/70 hover:text-rose-600 cursor-pointer"
                        >
              ...
              <div className="grid grid-cols-5 gap-2 pt-1">
                <input
                  ...
                  className="col-span-3 bg-white border border-[#0B1D2C]/30 rounded-full px-3 py-1.5 text-xs text-[#0B1D2C] focus:outline-none focus:border-[#0B1D2C]"
                />
                <input
                  type="number"
                  ...
                  placeholder="Birr"
                  className="col-span-2 bg-white border border-[#0B1D2C]/30 rounded-full px-3 py-1.5 text-xs text-[#0B1D2C] font-bold text-center focus:outline-none focus:border-[#0B1D2C]"
                />
              </div>

              <button
                onClick={handleAddExpenseItem}
                className="w-full py-2.5 rounded-full bg-white text-[#0B1D2C] border-2 border-[#0B1D2C] text-xs font-bold flex items-center justify-center gap-1 cursor-pointer hover:bg-[#f7f5f0] shadow-xs active:scale-95 transition-all"
              >
                <Plus className="w-3.5 h-3.5 text-[#0B1D2C]" />
            ...
            <div className="bg-[#f7f5f0] p-3.5 rounded-2xl border border-[#0B1D2C]/20 space-y-2">
              <div className="flex justify-between items-center text-xs">
                <span className="text-[#0B1D2C] font-bold flex items-center gap-1">
                  <Bike className="w-3.5 h-3.5 text-[#0B1D2C]" /> 3. BeU Delivery (የዴሊቨሪ ሂሳብ)
                </span>
                <span className="text-[#0B1D2C] font-extrabold text-xs">
            ...
            <div className="bg-[#f7f5f0] p-3.5 rounded-2xl border border-[#0B1D2C]/20 space-y-2">
              <div className="flex justify-between items-center text-xs">
                <span className="text-[#0B1D2C] font-bold">4. አዲስ ያልተከፈለ እዳ (New Credit Given)</span>
                <span className="text-[#0B1D2C] font-extrabold text-xs">
            ...
            <div className="bg-[#f7f5f0] p-3.5 rounded-2xl border border-[#0B1D2C]/20 space-y-2">
              <div className="flex justify-between items-center text-xs">
                <span className="text-[#0B1D2C] font-bold">5. የተመለሰ አሮጌ እዳ (Old Debts Collected)</span>
                <span className="text-[#0B1D2C] font-extrabold text-xs">
        ...
        <div className="bg-white border border-[#0B1D2C]/20 rounded-3xl p-4 space-y-2.5 shadow-md">
          <div className="flex items-center justify-between border-b border-[#0B1D2C]/15 pb-2">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-[#0B1D2C]/10 text-[#0B1D2C] flex items-center justify-center">
                <PenTool className="w-4 h-4" />
              </div>
              <div>
                <h2 className="font-extrabold text-[#0B1D2C] text-sm">የሰራተኛ ፊርማ (Worker Signature)</h2>
          ...
          <div className="bg-[#f7f5f0] rounded-2xl p-1 border border-[#0B1D2C]/20 overflow-hidden relative">
            <canvas
              ref={canvasRef}
              width={340}
              height={110}
            ...
            />
            {!hasSigned && (
              <div className="pointer-events-none absolute inset-0 flex items-center justify-center text-[#0B1D2C]/70 text-xs font-bold">
        ...
        <div className="bg-white text-[#0B1D2C] border border-[#0B1D2C]/20 rounded-3xl p-5 shadow-md space-y-4">
          <div className="flex justify-between items-center text-xs text-neutral-600 font-medium">
            <span>Gross Sales (ጠቅላላ ሽያጭ):</span>
            <span className="font-extrabold text-[#0B1D2C] text-base">
              {formatCurrency(totals.grossIncome, config.currencySymbol)}
            </span>
          </div>

          <div className="border-t border-[#0B1D2C]/15 pt-3">
            <p className="text-xs font-extrabold uppercase tracking-wider text-[#0B1D2C] mb-1">
              ለባለቤቱ የሚገባ ጥሬ ገንዘብ (Net Cash Due)
            </p>
            <h3 className="text-4xl font-extrabold text-[#0B1D2C]">
          ...
          <button
            ...
            disabled={saving}
            className="w-full h-14 rounded-full bg-[#0B1D2C] hover:bg-[#081521] text-white font-black text-lg shadow-lg flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 mt-3 active:scale-95 transition-all"
          >
            {saving ? (
              <div className="w-6 h-6 border-3 border-[#0B1D2C]/40 border-t-[#0B1D2C] rounded-full animate-spin" />
            ) : (
              <>
                <Send className="w-5 h-5 text-[#0B1D2C]" />
