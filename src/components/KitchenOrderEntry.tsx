              ...
              >
                ...
                <div className="text-left">
                  <div className="text-2xl font-extrabold flex items-center gap-2 text-[#403c21]">
                    <span>{t.label}</span>
                    {isAutoActive && (
                      <span className="text-xs bg-[#403c21] text-white font-extrabold px-2.5 py-0.5 rounded-full font-bold">
                        አሁን ያለው (Active)
                      </span>
                    )}
                  </div>
  ...
  const renderTodayOrders = () => (
    <div className="px-5 pb-6">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="ml-auto bg-[#403c21] text-white font-extrabold text-xs px-2.5 py-0.5 rounded-full font-extrabold shadow-xs">
          {todayOrders.length}
        </span>
      </div>
